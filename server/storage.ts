...
export class MemStorage implements IStorage {
  ...
  async updateDiscussion(id: number, partialDiscussion: Partial<InsertDiscussion>): Promise<Discussion | undefined> {
    ...
    const updatedDiscussion: Discussion = {
      ...
      captions: Array.isArray(partialDiscussion.captions)
        ? partialDiscussion.captions
        : discussion.captions || [],
    };
  ...
  async createReply(insertReply: InsertReply): Promise<Reply> {
    ...
    const reply: Reply = {
      ...
      captions: Array.isArray(insertReply.captions) ? insertReply.captions : [],
      helpfulCount: 0,
      upvoteCount: 0,
      downvoteCount: 0,
      createdAt: new Date(),
  ...
  async updateReply(id: number, partialReply: Partial<InsertReply>): Promise<Reply | undefined> {
    ...
    const updatedReply: Reply = {
      ...
      captions: Array.isArray(partialReply.captions)
        ? partialReply.captions
        : reply.captions || [],
    };
